...
//there three types of languages procedural ,functional ,object oriented 
//PROCEDURAL-specifies a series of well structured steps and procedure to compose a program
//FUNCTIONAL-writing a program only in pure function i.e. never modify variables but only create new ones as an output 
//OBJECT ORIENTED-revolves around objects
//static-everything like type checking and error detection will take place at compile time and declare your variable's datatype before you use it 
//dynamic-everythings like type checking and error detection will take place at runtime and no need to declare your variable's datatype .
//there two types of memory in programming language-stack memmory and heap memory
//if a=10 and b=38 then a,b(refernce variable) are stored in stack memory and 10,38(objects) are stored in heap memory.
//if no refernce variable is pointing towards an object then garbage collection hits and takes the object with it .

//FLOWCHARTS
//elipse represents start/stop
//parallelogram represents input/output
//rectangle represents processing
//rhombus/kite represents conditions
//arrow reps flow of diagram
...
//This code is contributed by shruti456rawal
 ...
 // System.out.println("hello world");
    ...
    //     float marks=98.67f;
    //     char letter='r';
    //     double largeDecimalNumber=4567676.67676;
    //     long longInteger=34567892837867673798L;
    //     boolean check=false; 
    // }   